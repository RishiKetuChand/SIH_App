...
public class DeveloperEmailFragment extends Fragment {
                ...
                if(emailInput.getText().toString().equals("")){
                    ...
                    serverRequestRepository.getServerService().getArchitect(architectRquest).enqueue(new Callback<ArctitectResponse>() {
                        ...
                        public void onResponse(Call<ArctitectResponse> call, Response<ArctitectResponse> response) {
                            ...
                            ClientEmailFragment clientEmailFragment = new ClientEmailFragment("project");
                            clientEmailFragment.setArguments(bundle);
                            getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.frameLayout, clientEmailFragment).commit();
                        }
                        @Override
    ...
    class UpdateDatabaseAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            if (buildingProject != null) {
                Log.i("TAGMain","buildingProject is empty");
                buildingProject.setDeveloper(architectDataArrayList.get(0));
