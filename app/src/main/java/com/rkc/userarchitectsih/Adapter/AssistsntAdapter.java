...
public class AssistsntAdapter extends  RecyclerView.Adapter<AssistsntAdapter.AssistsntAdapterViewHolder> implements Filterable  {

    Context context;
    ArrayList<CaseWorkerData> data = new ArrayList<>(), dataAll;

    public AssistsntAdapter(Context context, ArrayList<CaseWorkerData> data) {
    ...
    @NonNull
    @Override
    public AssistsntAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater=LayoutInflater.from(parent.getContext());
        View view=inflater.inflate(R.layout.draft_recycler_view_item,parent,false);
        return new AssistsntAdapter.AssistsntAdapterViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AssistsntAdapterViewHolder holder, int position) {
        ...
        holder.viewFile.setText("Open Camera");
        ...
        holder.approval.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                updateStatus(holder.getAdapterPosition(),"Site Verification","Sucessfull","next step");
            }
        });
        ...
        holder.reject.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                updateStatus(holder.getAdapterPosition(),"Site Verification","Falied","re-verify");
            }
        });
    ...
    public static class AssistsntAdapterViewHolder extends RecyclerView.ViewHolder {
        TextView applicationID, buildingOwner, buildingName;
        Button viewFile, reject,approval;
        LinearProgressIndicator linearProgressIndicator;
        View view;

        public AssistsntAdapterViewHolder(@NonNull View itemView) {
            super(itemView);
